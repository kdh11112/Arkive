...
public class EgovStringUtil {
	...
	private static Logger logger = LoggerFactory.getLogger(EgovStringUtil.class);
	...
	public static String getRandomStr(char startChr, char endChr) {
		...
		try {
			...
			logger.error("getRandomStr IllegalArgumentException", e);
		}
	...
	public static long getStringBytes(String soruce, String charset) {
		...
		try {
			...
			logger.error("getStringBytes UnsupportedEncodingException",e);
		}
	...
	public static String getThousandCommaSeperator(Object number) {
		...
		try {
			...
			logger.error("getThousandCommaSeperator NumberFormatException",e);
		}
		// 2020-12 소스취약점 END //
		return returnValue;
